...
- **`status`-fälten i registret är medvetet oförändrade** för HYP-037 och HYP-043 (fortfarande "passed") trots att de sakligt inte längre klarar sina egna låsta kriterier. Formellt beslut om statusändring är CEO:s, inte fattat än.
