"""
HYP-037: Villkorat/asymmetriskt aterinträde i SPY-krasch-overlayn pa
HYP-023 (idiosynkratisk vol + SPY-krasch-overlay + sektor-krasch-trigger,
HYP-023 fortfarande referensimplementationen).

Se research/hypothesis_registry/HYP-037-villkorat-overlay-aterintrade-hyp023.yaml
for det lasta kriteriet.

MOTIV: HYP-023:s egen genuina OOS-2025-test visade en Sharpe-nedgang som
VAXTE med kapitalniva (0.39/0.17/0.08) - motsatt kapacitetstesens onskan.
En genomgang av HELA HYP-023-familjens track record visade att de enda
TVA PASSED-hypoteserna (HYP-017, HYP-023 sjalva) BADA ar exponerings-
TIMINGsmekanismer, medan SJU oberoende urvals-/viktningsforsok (HYP-018,
022, 025-029, 031, 032, 034, 036) alla misslyckats.

TILLAGG mot HYP-023 (allt annat - signal, universum, friktion, hedge,
kapacitetsspärr, GLOBAL rankning, sektor-krasch-trigger MED sin egen
automatiska aterstallning - AR OFORANDRAT): SPY-krasch-overlayns
aterinträde byts fran "automatiskt vid nasta ombalansering" till
villkorat pa BADA: (a) SPY aterhamtat >=50% av det utlosande fallet,
(b) dagens genomsnittliga Corwin-Schultz-spread over HELA eligible-
