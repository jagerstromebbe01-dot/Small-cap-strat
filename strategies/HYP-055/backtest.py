"""
HYP-055: Cradle correlation - sektorlikviditets-lead-lag (branschledare/
-foljare, negativ/substituerande riktning).

Se research/hypothesis_registry/HYP-055-cradle-correlation-sektorlikviditet-lead-lag.yaml
for det lasta kriteriet - CEO:s egen ide, LAST 2026-08-10, forsta hypotesen
efter BATCH-002. Inga fria parametrar: mekaniken (branschgruppering,
tredjedelsuppdelning, 5-dagars ledaravkastning, 504-dagars 2-ars-
fordelning, kvintiltroskar, 5-dagars hallperiod) ar helt specificerad i
kriteriet - bara IMPLEMENTATIONSVAL (dokumenterade nedan, inte fria
parametrar i kriteriets mening) aterstar.
...
K_TOTAL_TRIALS = 54           # k_total_hypotheses_before_this (53) + 1, se YAML
