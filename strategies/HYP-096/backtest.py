"""
HYP-096 (BATCH-004, 4/4 textlikhet): Jaccard-likhet, undvikande-filter.
Se research/hypothesis_registry/HYP-096-riskfactors-jaccard-undvikandefilter.yaml
för det låsta kriteriet. Motorn är DELAD med HYP-093/094/095 - kopiera INTE.
"""
import json
import sys
...
def main():
    print(f"=== HYP-096: Risk Factors-textlikhet (metric={METRIC}, konstruktion={CONSTRUCTION}) ===\n")
