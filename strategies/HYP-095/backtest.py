"""
HYP-095 (BATCH-004, 3/4 textlikhet): Jaccard-likhet, eget
long/short-ben. Se
research/hypothesis_registry/HYP-095-riskfactors-jaccard-sjatteben.yaml
för det låsta kriteriet. Motorn är DELAD med HYP-093/094/096 - kopiera INTE.
"""
import json
import sys
...
def main():
    print(f"=== HYP-095: Risk Factors-textlikhet (metric={METRIC}, konstruktion={CONSTRUCTION}) ===\n")
