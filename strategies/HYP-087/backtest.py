"""
HYP-087: Havstang (2,5x, gating) med marginalanrop/tvingad nedskalning
som overlay pa HYP-081:s redan kombinerade portfolj.

Se research/hypothesis_registry/HYP-087-havstang-margin-anrop-hyp081.yaml
for det lasta kriteriet. IDENTISK marginalanrops-mekanism som HYP-059/065
(strategies/HYP-065/backtest.py) - ENDA skillnaden ar basen (HYP-081
istallet for HYP-056) och referens-CAGR:et villkor 2 jamfors mot.
...
DSR_N_TRIALS = 84  # k_total_hypotheses_before_this (83) + 1
...
def main():
    ...
    print("=== HYP-087: havstang 2,5x (gating) med marginalanrop-overlay pa HYP-081 ===\n")
    ...
    for level in levels:
        ...
        print("              -- disclosure (1,5x/2,0x/3,0x, konservativ spread) --")
