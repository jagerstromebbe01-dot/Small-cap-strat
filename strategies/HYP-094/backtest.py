"""
HYP-094 (BATCH-004, 2/4 textlikhet): cosine/TF-IDF-likhet,
undvikande-filter. Se
research/hypothesis_registry/HYP-094-riskfactors-cosine-undvikandefilter.yaml
för det låsta kriteriet. Motorn är DELAD med HYP-093/095/096 - kopiera INTE.
"""
import json
import sys
...
METRIC = "cosine"
CONSTRUCTION = "avoidance_filter"
DSR_N_TRIALS = 95


def main():
    print(f"=== HYP-094: Risk Factors-textlikhet (metric={METRIC}, konstruktion={CONSTRUCTION}) ===\n")
