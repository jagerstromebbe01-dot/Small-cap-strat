...
HYP-027 (BATCH-001, kandidat 3/5): TREDJE lager, ett per-position
stop-loss pa -25%, EFTER bade SPY-overlayen och sektor-triggern. Se
research/hypothesis_registry/HYP-027-stoploss-25pct.yaml for det lasta
...
# Per-position stop-loss (ny i HYP-027, BATCH-001 kandidat 3/5 - se
...
def run_backtest(close, close_adj, hedge, vol_df, beta_df, spread_df, volume,
    ...
    for date_i in range(start_idx, len(close.index)):
        ...
        # ── Per-position stop-loss (ny, HYP-027/BATCH-001): DAGLIG
