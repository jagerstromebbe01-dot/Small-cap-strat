"""
HYP-097 (BATCH-004, 1/4 accrual): skalning mot totala tillgångar,
long-only lägsta decilen. Se
research/hypothesis_registry/HYP-097-accrual-tillgangar-longonly.yaml
för det låsta kriteriet. Motorn (strategies/common/accrual_engine.py)
är DELAD med HYP-098/099/100 - kopiera INTE, se den filens docstring.
"""
import json
import sys
...
def main():
    print(f"=== HYP-097: Accrual (skalning={SCALING}, konstruktion={CONSTRUCTION}) ===\n")
