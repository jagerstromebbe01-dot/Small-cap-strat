"""
HYP-100 (BATCH-004, 4/4 accrual): skalning mot marknadsvärde,
long/short. Se
research/hypothesis_registry/HYP-100-accrual-marknadsvarde-longshort.yaml
för det låsta kriteriet. Motorn (strategies/common/accrual_engine.py)
är DELAD med HYP-097/098/099 - kopiera INTE.
"""
import json
import sys
...
def main():
    print(f"=== HYP-100: Accrual (skalning={SCALING}, konstruktion={CONSTRUCTION}) ===\n")
